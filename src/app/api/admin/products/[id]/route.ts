 ...
 * Update a product. Requires super-admin or admin role.
 */
export async function PATCH(req: NextRequest, { params }: Params) {
  ...
  try {
    ...
    await adminDb.collection('products').doc(id).update({ ...body, updatedAt: new Date().toISOString() })
 ...
 * Delete a product. Requires super-admin or admin role.
 */
