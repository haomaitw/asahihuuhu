...
/**
 * GET /api/admin/news
 * List news items ordered by date desc.
 */
...
/**
 * POST /api/admin/news
 * Create a news item. Requires super-admin or admin.
 */
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    const ref = await adminDb.collection('news').add({ ...body, createdAt: now, updatedAt: now })
